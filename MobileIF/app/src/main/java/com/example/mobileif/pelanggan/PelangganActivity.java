package com.example.mobileif.pelanggan;
...
import com.example.mobileif.Adapter.AdapterPelanggan;
...
public class PelangganActivity extends AppCompatActivity {
    ...
    private void setView() {
        ...
        btnPelAdd = findViewById(R.id.btnPelAdd); // Temukan tombol tambah pelanggan dari layout
